...
public interface FavouriteRepository extends JpaRepository<Favourite, Integer> {
        ...
        boolean existsByVariant(com.techone.model.Variant variant);

        java.util.Optional<Favourite> findByAccountAndPost(com.techone.model.Account account,
                        com.techone.model.Post post);
